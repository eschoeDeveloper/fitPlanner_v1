...
public class Admin {
    ...
    @ManyToOne(targetEntity = AdminRole.class, fetch = FetchType.EAGER)
    @JoinColumns(value = {
    ...
    @Builder
    public Admin(String id, String name, String password, String phone, String gender, String age, int roleSeq, String registId, String updateId, String delYn) {
